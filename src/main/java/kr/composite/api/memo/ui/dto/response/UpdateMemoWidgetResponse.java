...
@Schema(description = "메모 위젯 수정 응답")
public record UpdateMemoWidgetResponse(
    ...
    public static UpdateMemoWidgetResponse from(MemoWidgetResponse response) {
        return new UpdateMemoWidgetResponse(
                response.id(),
                response.widgetId(),
                response.title(),
                response.content(),
